...
const KANJI = [
  ["山", "やま", "山に のぼる"], ["川", "かわ", "川で およぐ"],
  ["日", "ひ", "日が しずむ"], ["月", "つき", "月が みえる"],
  ["火", "ひ", "火を けす"], ["水", "みず", "水を のむ"],
  ["木", "き", "木に のぼる"], ["人", "ひと", "人が いる"],
  ["口", "くち", "口を あける"], ["目", "め", "目を とじる"],
  ["耳", "みみ", "耳で きく"], ["手", "て", "手を あらう"],
  ["足", "あし", "足で あるく"], ["犬", "いぬ", "犬が はしる"],
  ["花", "はな", "花が さく"], ["空", "そら", "空を みる"],
  ["雨", "あめ", "雨が ふる"], ["石", "いし", "石を ひろう"],
  ["田", "た", "田に みずを はる"], ["森", "もり", "森を あるく"],
];
...
export const FISH_INFO = {
  ...
  たなご: ["ちいさく ひらたい からだ", "かわや いけなどの みずべで みられる ちいさな さかなだよ。"],
  もつご: ["ほそめの ちいさな からだ", "かわや いけなどで くらす ちいさな さかなだよ。"],
  うぐい: ["すらりとした からだ", "かわを ちゅうしんに くらす さかなの なかまだよ。"],
  おいかわ: ["ほそながい からだ", "かわの ながれが ある ところでも みられる さかなだよ。"],
  くろだい: ["くろっぽい ぎんいろの からだ", "かいがんに ちかい うみなどで くらす たいの なかまだよ。"],
  かれい: ["ひらたい からだ", "うみの そこに ちかい ところで くらす ひらたい さかなだよ。"],
  きす: ["ほそながい からだ", "すなの ある あさい うみで みられることが あるよ。"],
  すずき: ["おおきな くちと ほそながい からだ", "かいがんや かわぐちの ちかくでも みられる さかなだよ。"],
  ぼら: ["まるみの ある ほそながい からだ", "かいがんや かわぐちの ちかくで くらすことが あるよ。"],
  かくれくまのみ: ["あざやかな しまもよう", "さんごしょうの ちかくで、いそぎんちゃくと いっしょに くらすことが あるよ。"],
  なんようはぎ: ["あおい からだと きいろい ひれ", "あたたかい うみの さんごしょうで みられる さかなだよ。"],
  ちょうちょううお: ["うすく ひらたい からだ", "さんごしょうの まわりで みられる いろあざやかな なかまだよ。"],
  つのだし: ["ながく のびた せびれ", "さんごしょうの ちかくで みられる、せびれが めだつ さかなだよ。"],
  ぶだい: ["じょうぶな くち", "さんごしょうの ちかくで くらす なかまが おおいよ。"],
  みのかさご: ["ながく ひろがる ひれ", "ながい ひれが めだつ さかなで、ひれの とげには ちゅういが ひつようだよ。"],
  かつお: ["すばやく およぎやすい からだ", "ひろい うみを むれで およぐことが ある さかなだよ。"],
  しいら: ["ひたいが たかい ほそながい からだ", "あたたかい うみの ひょうめんに ちかい ところを およぐ なかまだよ。"],
  かじき: ["やりのように ながい くち", "まえに ながく のびた くちが とくちょうの おおきな さかなだよ。"],
  よしきりざめ: ["ほそながい さめの からだ", "ひろい うみを およぐ さめの なかまだよ。"],
  ふうせんうなぎ: ["とても おおきく ひらく くち", "ふかい うみに すむ、くちが おおきく ひらく なかまだよ。"],
  でめにぎす: ["うえを むく め", "ふかい うみに すみ、ひかりを とらえる とくちょうのある めを もつよ。"],
  きんめだい: ["あかい からだと おおきな め", "やや ふかい うみで くらす おおきな めの さかなだよ。"],
  あかむつ: ["あかっぽい からだ", "ふかめの うみで くらす さかなの なかまだよ。"],
  ほうらいえそ: ["おおきな きばのような は", "ふかい うみに すみ、おおきな はが とくちょうの なかまだよ。"],
  めがまうす: ["とても おおきな くち", "ふかい うみにも くらす、おおきな くちが とくちょうの さめだよ。"],
  なぽれおんふぃっしゅ: ["もりあがった おでこ", "さんごしょうで くらす おおきな べらの なかまだよ。"],
  たまかい: ["おおきく がっしりした からだ", "あたたかい うみの いわばや さんごしょうで くらす おおきな はたの なかまだよ。"],
  ろうにんあじ: ["がっしりした からだ", "あたたかい うみを およぐ おおきな あじの なかまだよ。"],
  ばしょうかじき: ["ながい くちと おおきな せびれ", "ほを ひろげたような おおきな せびれが とくちょうだよ。"],
};
const FISH_FEATURE_BY_SHAPE = {
  tiny: "ちいさな からだ",
  eel: "ほそながい からだ",
  flat: "ひらたい からだ",
  puffer: "ふくらむ からだと とげ",
  sword: "まえに ながく のびた くち",
  sunfish: "まるく ひらたい からだ",
  angler: "あたまの えさを さそう ぶぶん",
  ray: "つばさのような おおきな ひれ",
  ribbon: "とても ながく ひらたい からだ",
  shark: "さめらしい りゅうせんけいの からだ",
  fish: "ひれの ある さかなの からだ",
};
for (const fish of FISH)
  FISH_INFO[fish.name] ||= [
    FISH_FEATURE_BY_SHAPE[fish.shape] || "ひれの かたち",
    fish.fact,
  ];
const fishInfoRows = () => FISH.filter((f) => FISH_INFO[f.name]);
const fishHome = (f) => ["water_0", "water_1"].includes(f.area) ? "かわ・いけの つりば" : "うみの つりば";
...
export const ANIMAL_INFO = {
  ...
  ごりら: ["🦍", "もり", "はっぱや くだもの", "あるく", "おおきな からだの さるの なかまだよ。"],
  ...
  たぬき: ["🦝", "もりや さと", "いろいろ", "あるく", "よるに かつどうすることが おおい ほにゅうるいだよ。"],
  だちょう: ["🐦", "そうげん", "くさや たねなど", "はしる", "そらは とべないけれど、とても はやく はしれる とりだよ。"],
  しろながすくじら: ["🐋", "うみ", "おきあみなど", "およぐ", "げんざい しられている どうぶつの なかで もっとも おおきな なかまだよ。"],
  くらげ: ["🪼", "うみ", "ぷらんくとんなど", "およぐ", "からだの おおくが みずで できている なかまだよ。"],
  まんもす: ["🦣", "さむい くさはら", "くさ", "あるく", "ながい けと おおきな きばを もつ ぞうの なかまだよ。"],
  すみろどん: ["🐅", "もりや くさはら", "にく", "はしる", "ながい きばが とくちょうの ぜつめつした ほにゅうるいだよ。"],
  めがろどん: ["🦈", "うみ", "さかなや うみのどうぶつ", "およぐ", "むかしの うみに いた とても おおきな さめの なかまだよ。"],
  もささうるす: ["🦎", "うみ", "さかななど", "およぐ", "きょうりゅうではなく、むかしの うみに いた はちゅうるいの なかまだよ。"],
  ぷてらのどん: ["🪽", "うみべや そら", "さかななど", "とぶ", "きょうりゅうではなく、そらを とんだ よくりゅうの なかまだよ。"],
  えらすもさうるす: ["🦕", "うみ", "さかななど", "およぐ", "ながい くびを もつ うみの はちゅうるいの なかまだよ。"],
};
...
function japaneseQuestion(level, index) {
  ...
  if (level === 9) {
    ...
    return choice(`${row[2]}。この「${row[0]}」は なんと よむ？`, row[1], shuffle(KANJI.filter((x) => x !== row && x[1] !== row[1]).map((x) => x[1])).slice(0, 3), `この ぶんでは「${row[1]}」と よむよ。`);
  }
...
function fishQuestion(level, index) {
  ...
  if (level === 2) {
    ...
    return choice(
      `${f.name}は このゲームでは どの つりばグループ？`,
      home,
      home === "うみの つりば" ? ["かわ・いけの つりば", "やま", "そら"] : ["うみの つりば", "やま", "そら"],
      `このゲームでは ${f.name}は ${home}で みつかるよ。`,
      { visual: "creature", creature: f.id },
    );
  }
  if (level === 3 || level === 4) {
