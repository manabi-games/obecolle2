...
assert.ok(main.includes("Version 1.3.0"));
...
console.log(
  `PASS: Obecolle2 v1.3 verifier (${generated} questions; coverage fish=${creatureCoverage.fish.size}, dinos=${creatureCoverage.dinosaurs.size}, animals=${creatureCoverage.animals.size})`,
);
